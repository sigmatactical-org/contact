...
Data is stored in the shared PostgreSQL `contact` schema (`contact.document` JSONB table). Start Postgres from [sigma-pg](https://github.com/sigmatactical-org/sigma-pg):
